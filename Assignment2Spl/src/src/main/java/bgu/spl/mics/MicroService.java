...
public abstract class MicroService implements Runnable {
    ...
    HashMap<Class<? extends Message>, Callback > evenToCall = new HashMap<Class<? extends Message>, Callback>();
    ...
    public final void run() {
        bus.register(this);
    	initialize();
        while (!terminated) {//maybe need try and catch because awaitmessage throws stuffs
        	Message msg = bus.awaitMessage(this);
        	evenToCall.get(msg).call(msg);
        }
    }
